namespace calx.Migrations
{
    ...
    public partial class Initial : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        CarStyleId = c.Int(nullable: false),
                    })
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.CarStyles", t => t.CarStyleId, cascadeDelete: true)
                .ForeignKey("dbo.Transmissions", t => t.TransmissionId, cascadeDelete: true)
                .Index(t => t.TransmissionId)
                .Index(t => t.CarStyleId);
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Cars", "CarStyleId", "dbo.CarStyles");
            ...
            DropIndex("dbo.Cars", new[] { "CarStyleId" });
